    ...
    <Navbar/>
      <Box className={styled.container}>
        ...
        <div className={styled.supportmaindiv}>
          ...
          <hr></hr>
          <p
            // className="support_hours"
            className={styled.support_hours}
          ...
          <h1>Message</h1>
          <textarea style={{padding:"10px "}}  placeholder="What's your issue or question?"></textarea>
          <h1>Name</h1>
